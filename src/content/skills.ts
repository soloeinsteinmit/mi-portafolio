...
export const skills: SkillGroup[] = [
  {
    ...
    items: [
      ...
      { name: "AWS", depth: "core" },
      { name: "Databricks", depth: "working" },
      { name: "CI/CD", depth: "core" },
      { name: "Observability", depth: "core" },
      { name: "Terraform", depth: "core" },
      { name: "Azure DevOps", depth: "core" },
      { name: "Kafka", depth: "working" },
      { name: "Snowflake", depth: "working" },
      { name: "Iceberg", depth: "core" },
      { name: "Celery", depth: "working" },
      { name: "RabbitMQ", depth: "working" },
      { name: "PostgreSQL", depth: "core" },
      { name: "MySQL", depth: "working" },
      { name: "MongoDB", depth: "familiar" },
      { name: "Redis", depth: "familiar" },
      { name: "ETL / data pipelines", depth: "core" },
      { name: "Production ML operations", depth: "core" },
    ],
  },
  {
    ...
    items: [
      ...
      { name: "Computer vision", depth: "working" },
      { name: "YOLO", depth: "working" },
      { name: "TensorFlow", depth: "working" },
      { name: "Pandas", depth: "core" },
      { name: "NumPy", depth: "core" },
      { name: "Polars", depth: "working" },
      { name: "Apache Spark", depth: "familiar" },
      { name: "MLlib Apache Spark", depth: "familiar" },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { name: "MetaTrader 5", depth: "familiar" },
      { name: "MQL5", depth: "familiar" },
    ],
  },
  {
