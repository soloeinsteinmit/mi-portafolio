  ...
  return (
    <>
      <Head>
        ...
        <meta name="twitter:title" content="Solomon Eshun (Solo Shun) | AI/ML Engineer, MLOps & DataOps Specialist & Quantitative Finance" />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "jobTitle": "AI/ML Engineer & MLOps & DataOps Specialist",
              "worksFor": [
                {
                  "@type": "Organization",
